...
if(isset($_GET["id"]))
{
	$id_cabotaje=$_GET["id"];
	//1.
	$sql2="SELECT id,id_guia,piezas,peso,volumen FROM cabotaje WHERE id = '$id_cabotaje'";
	...
	while($fila2=mysql_fetch_array($consulta2))
	{
		...
		//2.
		$sql_despacho="DELETE FROM cabotaje WHERE id='$id_registro'";
		...
		$sql_trak="INSERT INTO tracking (id_guia,
										 ...
										 id_usuario) value 
												('$id_guia',
												 ...
												 POR QUE ELIMINAN EL DESPACHO No.$id_cabotaje',
												 '1',
												 '$id_usuario')";
