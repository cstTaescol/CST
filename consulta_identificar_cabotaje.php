...
require("menu.php");
?>
<p class="titulo_tab_principal">Buscador de Cabotajes</p>
...
if (isset($_POST["coincidencia"]) or isset($_POST["rango"]))
	{
		...
		if	($condicion != "Error")
			{
				$sql="SELECT * FROM cabotaje WHERE $condicion AND estado ='A'";
				...
				while($fila=mysql_fetch_array($consulta))
					{
						...
						echo "<tr>
								<td align=\"center\" class=\"celda_tabla_principal celda_boton\">
									<button type=\"button\" onClick=\"abrir('pdf_cabotaje.php?id_cabotaje=$id_cabotaje')\">
										<img src=\"imagenes/imprimir-act.png\" title=\"Impresion\" />
									</button> 
								</td>
								<td align=\"center\" class=\"celda_tabla_principal celda_boton\">
									<button type=\"button\" onClick=\"document.location='modificar_cabotaje1.php?id=$id_cabotaje'\" $activacion1>
										<img src=\"imagenes/settings-act.png\" title=\"Modificar\" />
									</button>
								</td>
								<td align=\"center\" class=\"celda_tabla_principal celda_boton\">
									<button type=\"button\" onClick=\"conf_eliminar($id_cabotaje);\" $activacion2>
										<img src=\"imagenes/eliminar-act.png\" title=\"Eliminar\" />
									</button>
								</td>								
								<td class=\"celda_tabla_principal celda_boton\"> $id_cabotaje </td>
