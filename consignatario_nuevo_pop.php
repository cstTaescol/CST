...
function verificar_nit()
{
	var peticion = new Request(
	{
		...
		onFailure: function()
		{
			$('respuesta').innerHTML='<p align="center">Error al consultar, Intente de nuevo...</p>';
			$('guardar').disabled=false;
			$('reset').disabled=false;
		}
	}
...
<form  action="#" onSubmit="return validar();" method="post">
    <table align="center">
      ...
      <tr>
        ...
        <td class="celda_tabla_principal celda_boton"><input type="text" name="razon_social" id="razon_social" size="40" placeholder="Ingrese el nombre" onkeypress="verificar_nombre()" ><font color="red">*</font></td>
      </tr> 
