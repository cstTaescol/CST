<?php
	$sql="SELECT * FROM consignatario WHERE id='$id_registro'";
    ...
    <table width="450" align="center">
        ...
        <tr>
          <td align="center" valign="middle" class="celda_tabla_principal celda_boton">
            <button type="button" name="cancelar" id="cancelar" onclick="document.location='listar_consignatario.php'">
...
function guardar_form()
{
	...
	{
		url: 'consignatario_modificar_salvar.php',
		method: 'post',
		onRequest: function()
		{
		...
		onSuccess: function(responseText)
		{
			...
			switch (respuesta)
			{
				...
				case 1:
					...
					document.location='listar_consignatario.php';
				break;
			}
