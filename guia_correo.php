  ...
  <tr>
    <td>
      <table width="90%" align="center">
                <tr>
                  <td colspan="2" class="asterisco" align="center">Guia Correo</td>
                </tr>
                <tr>
                  <td class="celda_tabla_principal"><div class="letreros_tabla">Disposicion de Carga</div></td>
                  <td width="60%" class="celda_tabla_principal celda_boton"><p>
                  	<font color="#FF0000"><strong>(*)</strong></font>
                    <select name="disposicion" id="disposicion" tabindex="2">
                      <option value="26">ENVIO DE CORRESPONDENCIA</option>
                      <option value="27">MENSAJERIA ESPECIALIZADA</option>
                      </select>
                ...
                <tr>
                  ...
                  <td class="celda_tabla_principal celda_boton"><div id="dv_embarcador"> <font color="#FF0000"><strong>(*)</strong></font>
                ...
                <tr>
                  ...
                  <td class="celda_tabla_principal celda_boton"><p>
                    ...
                    <!-- formulario con el campo de texto y el bot&oacute;n para lanzar el calendario-->
                ...
                <tr>
                  ...
                  <td class="celda_tabla_principal celda_boton"><div id="dv_agente">
                    <p>
                      <font color="#FF0000"><strong>(*)</strong></font>
                ...
                <tr>
                  ...
                  <td class="celda_tabla_principal celda_boton">
                    NO <input type="radio" name="precursor" value="N" checked="checked" tabindex="16" />
...
<table width="450" align="center">
    ...
    <tr>
      <td align="center" valign="middle" class="celda_tabla_principal celda_boton"><button type="reset" name="reset" id="reset"> <img src="imagenes/descargar-act.png" alt="" title="Limpiar" /></button>
        <button type="submit" name="guardar" id="guardar"> <img src="imagenes/guardar-act.png" alt="" title="Guardar" /> </button></td>
    </tr>
</table>
