...
function verificar_nombre()
{
	...
	peticion.send('valorBusqueda='+$('razon_social').value+'&tbl=agente_carga');	
}
...
<form  action="#" onSubmit="return validar();" method="post">
    <table align="center">
      ...
      <tr>
        ...
        <td class="celda_tabla_principal celda_boton"><input name="direccion" id="direccion" type="text" size="30" maxlength="200" tabindex="3" /></td>
      </tr>
      <tr>
        <td class="celda_tabla_principal"><div class="letreros_tabla">E-mail</div></td>
        <td class="celda_tabla_principal celda_boton">
            <p><input name="emails" id="emails" type="text" size="30" tabindex="4"/></p>
    ...
    <table width="450" align="center">
        ...
        <tr>
          <td align="center" valign="middle" class="celda_tabla_principal celda_boton">
            <button type="button" name="cancelar" id="cancelar" onClick="document.location='consulta_identificar_parametricas.php?tabla=agente_carga'">
...
if(isset($_POST["tipo_documento"]))
{
	...
	$sql="INSERT INTO agente_carga (no_identificacion,								
									id_tipo_documento,
									primer_apellido,
									segundo_apellido,
									primer_nombre,
