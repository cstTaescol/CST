...
<html>
  <head>
    <title>Reporte de Entrega Courier</title>
  </head>
  <body>
    <?php
    require("menu.php");
    ...
    <table width="450" align="center">
        ...
        <tr>
          <td align="center" valign="middle" class="celda_tabla_principal celda_boton">
                ...
                <button name="imprimir" type="button" onClick="abrir('pdf_despacho_courier.php?id_registro=<?php echo $id_registro ?>')">
...
<script language="javascript">
  ...
  function conf_eliminar(url)
  {
    ...
    if (respuesta)
      {
        window.location="eliminar_despacho_courier1.php?id_registro="+url+"&opcion=eliminar";
      }
  }
</script>