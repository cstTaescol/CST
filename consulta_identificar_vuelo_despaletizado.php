...
<input type="hidden" name="tipo_reporte" id="tipo_reporte" value="<?php echo $_REQUEST['tipo_reporte']; ?>">
<table align="center">
  <tr>
		...
		if	($condicion != "Error")
			{
				...
				{
					case "reducido":
						$archivo_reporte='reportes/reporte_despaletizaje_reducido.php';
					break;
					case "reducido_pdf":
						$archivo_reporte='pdf_despaletizaje.php';
					break;
					case "completo":
						$archivo_reporte='reportes/reporte_despaletizaje_completo.php';
					break;
				}
				...
				while($fila=mysql_fetch_array($consulta))
					{
						...
						echo '<tr>
								...
								<td align="center"  class="celda_tabla_principal celda_boton" > 
									<button type="button" onclick="openPopup(\''.$archivo_reporte.'?id_vuelo='.$id_vuelo.'\',\'new\',\'900\',\'450\',\'scrollbars=1\',true);">
