...
//Contador de paginas
$sql="SELECT id FROM embarcador WHERE estado='$estado_tabla'";
...
//*****************
$sql="SELECT * FROM embarcador WHERE estado='$estado_tabla' ORDER BY nombre ASC LIMIT $pagina , 100";
...
while($fila=mysql_fetch_array($consulta))
	{
		...
		<tr>
		  ...
		  <td class=\"celda_tabla_principal celda_boton\" align=\"center\">
		  	<button type=\"button\" onclick=\"document.location='cambiar_estado_parametricas.php?tabla=embarcador&id_registro=".$fila['id']."&estado_actual=".$fila['estado']."'\">X
			</button>	
		  </td>
		  <td class=\"celda_tabla_principal celda_boton\" align=\"center\">
		  	<button type=\"button\" onclick=\"document.location='modificar_parametrica.php?tabla=embarcador&id_registro=".$fila['id']."'\">Modificar</button>	
		  </td>			
		</tr>";
	}
...
require("menu.php");
?>
<p class="titulo_tab_principal">Lista de Embarcadores</p>
