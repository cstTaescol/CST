...
<form method="post" name="vehiculo" onsubmit="return validar();" action="<?php echo $_SERVER['SCRIPT_NAME'] ?>">
  <table align="center">
      ...
      <tr>
        ...
        <td class="celda_tabla_principal celda_boton">
          <select name="id_entidad" id="id_entidad" tabindex="3">
            <?php
      				$sql="SELECT id,nombre FROM courier_entidades WHERE estado='A' AND id !='6' AND id !='7' ORDER BY nombre ASC";
  ...
  <table width="450" align="center">
      ...
      <tr>
        <td align="center" valign="middle" class="celda_tabla_principal celda_boton">
          <button type="button" name="cancelar" id="cancelar" onClick="document.location='consulta_identificar_parametricas.php?tabla=courier_funcionario_entidad'">
...
if(isset($_POST["no_documento"]))
    ...
    $id_entidad=$_POST["id_entidad"];  
		...
		$sql="INSERT INTO courier_funcionario (nombre,no_documento,id_entidad) value('$nombre','$no_documento','$id_entidad')";
    ...
    <script language="javascript">
      ...
      document.location="consulta_identificar_parametricas.php?tabla=courier_funcionario_entidad";
		</script>
    ';    
	}
?>
