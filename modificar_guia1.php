...
if(isset($_REQUEST["id_guia"]))
	{
		...
		if ($resultado != true)
		{
			...
			if ($id_tipo_bloqueo == 4 || $id_tipo_bloqueo == 5 || $id_tipo_bloqueo == 8) //entregada, bloqueada, anulada
			{
				echo "<script>
		...
		if($piezas_faltantes=="")
		{
			...
			{
				$accionar="readonly";
				$imagen='<img src="imagenes/candado_cerrado.png" title="Bloqueado por tener INCONSISTENCIAS" width="20" height="20" align="absmiddle">';
			}
	}
?>
<html>
...
<table align="center">
  ...
  <tr>
   ...
   <tr>
    ...
    <tr>
		...
		<td class="celda_tabla_principal celda_boton">
        	<input name="piezas" type="text" id="piezas" tabindex="5" onKeyPress="return numeric(event)" value="<?php echo $piezas?>" size="5" maxlength="10" <?php echo $accionar ?>><font color="#FF0000">(*)</font><?php echo $imagen ?>
        </td>
  </tr>
  <tr>
    	<td class="celda_tabla_principal"><div class="letreros_tabla">Peso</div></td>
    	<td class="celda_tabla_principal celda_boton">
        	<input name="peso" type="text" id="peso" tabindex="6" onKeyPress="return numeric2(event)" value="<?php echo $peso?>" size="5" maxlength="10" <?php echo $accionar ?>><font color="#FF0000">(*)</font><?php echo $imagen ?>
        </td>
  </tr>
  ...
  <tr>
    	...
    	<td class="celda_tabla_principal celda_boton">
        	<input name="volumen" type="text" id="volumen" tabindex="7" onKeyPress="return numeric2(event)" value="<?php echo $volumen?>" size="5" maxlength="10" <?php echo $accionar ?>><?php echo $imagen ?>
        </td>
   </tr>
  <tr>
