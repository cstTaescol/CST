...
if(isset($_GET["order"]))
{
	...
	{
		case "d": //Depositos
		$disposiciones="id_disposicion='10' OR id_disposicion='11' OR id_disposicion='18' OR id_disposicion='22'";
		...
		case "b":
		$disposiciones="id_disposicion='26' OR id_disposicion='27'"; //Correo
		$campo="id_disposicion";
		$parametro="g.id_disposicion";
		$baner="CORREO";
		break;
		
		case "t":
		$disposiciones="id_disposicion='13' OR id_disposicion='14' OR id_disposicion='23'"; //Trasbordo
		$campo="id_disposicion";
		$parametro="g.id_disposicion";
		$baner="TRASBORDOS";
		break;
		...
		case "c":
		$disposiciones="id_disposicion='12' OR id_disposicion='16' OR id_disposicion='17' OR id_disposicion='24'"; //Cabotaje
		$parametro="g.id_deposito";
		$campo="id_deposito";
		$baner="CABOTAJES";
		break;
		...
		case "i":
		$disposiciones="id_disposicion='19' OR id_disposicion='20' OR id_disposicion='21'"; //Descargue Directo
		$campo="id_disposicion";
		$parametro="g.id_disposicion";
		$baner="DESCARGUES DIRECTOS";
		break;

		case "o":
		$disposiciones="id_disposicion='15' OR id_disposicion='25' OR id_disposicion='28' OR id_disposicion='29'"; //Otros
		$campo="id_disposicion";
		$parametro="g.id_disposicion";
		$baner="OTROS";
		break;
...
<p class="asterisco" align="center"><?php echo $baner ?></p>
<table width="2700">
  <tr>
    ...
    <td width="180" align="center" class="celda_tabla_principal">Vuelo <a href="inventario_general.php?order=v"><img src="imagenes/abajo-act.png" title="Ordenar" border="0" align="absmiddle" /></a></td>
    <td width="260" align="center" class="celda_tabla_principal">Aerolinea <a href="inventario_general.php?order=a"><img src="imagenes/abajo-act.png" title="Ordenar" border="0" align="absmiddle" /></a></td>
    <td width="400" align="center" class="celda_tabla_principal" style="background-color:#FFCC00">
    	Destino<br />
	...
	<td width="270" align="center" class="celda_tabla_principal">Consignatario <a href="inventario_general.php?order=c"><img src="imagenes/abajo-act.png" title="Ordenar" border="0" align="absmiddle" /></a></td>
...
$sql="SELECT v.id_aerolinea,v.nvuelo,v.hora_finalizado,v.nmanifiesto,v.id AS 'id_vuelo',g.* FROM vuelo v LEFT JOIN guia g ON v.id = g.id_vuelo WHERE  g.id_tipo_guia !='2' AND (id_tipo_bloqueo = '3' OR id_tipo_bloqueo = '5' OR id_tipo_bloqueo = '6' OR id_tipo_bloqueo = '9' OR id_tipo_bloqueo = '10') AND (g.faltante_total='N') AND ($disposiciones) $sql_aerolinea ORDER BY $parametro ASC";
