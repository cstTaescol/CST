...
$impresion="";
$id_cabotaje=$_REQUEST["id_cabotaje"];
//carga datos de la remesa
$sql="SELECT * FROM cabotaje WHERE id='$id_cabotaje' AND estado='A'";
...
<table border="2" cellspacing="0" cellpadding="0" width="650">
  <tr>
    ...
    <td width="380" align="center"><strong><font size="+3"><br />PLANILLA DE CABOTAJE</font></strong></td>
...
<table width="650" border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="235" align="center"><font color="#990000" size="+4">$id_cabotaje</font></td>
  </tr>
</table>
<br />
<table width="650" border="1" cellspacing="0" cellpadding="0">
...
$pdf->Output('Reporte_Cabotaje'.$id_cabotaje.'.pdf', 'I');
