<form action="guia_salvar.php" method="post" name="registro_guia" id="registro_guia" onsubmit="return validar();">
<table width="90%" align="center" class="celda_tabla_principal">
  <tr>
    <td>
        <table width="90%" align="center">
          <tr>
            <td class="asterisco" colspan="2" align="center">Guia Hija</td>
          </tr>
          <tr>
            <td class="celda_tabla_principal"><div class="letreros_tabla">Administracion Aduanera</div></td>
            <td class="celda_tabla_principal celda_boton"><font color="#FF0000"><strong>(*)</strong></font>
          ...
          <tr>
            ...
            <td class="celda_tabla_principal celda_boton"><p> <font color="#FF0000"><strong>(*)</strong></font>
          ...
          <tr>
            ...
            <td class="celda_tabla_principal celda_boton"><font color="#FF0000"><strong>(*)</strong></font>
              <select name="master" id="master" tabindex="3">
                <option value="">Seleccione Uno</option>
                <?php
                            ...
                            while($fila=mysql_fetch_array($consulta))
                            {
                                echo '<option value="'.$fila['id'].'">'.$fila['master'].'</option>';
                            }
                        ?>
              </select>
              <button type="button" name="btn_limpiar_master" id="btn_limpiar_master" onclick="openPopup('guia_master_popup.php','new','750','400','scrollbars=1',true)"> <img src="imagenes/eliminar-act.png" title="Desactivar Guias Master" align="absmiddle"/></button>
              </td>
          </tr>
          <tr>
            <td class="celda_tabla_principal"><div class="letreros_tabla">No Guia</div></td>
            <td class="celda_tabla_principal celda_boton"><font color="#FF0000"><strong>(*)</strong></font>
              <input name="guia" id="guia" type="text" tabindex="4" size="20" maxlength="20" onkeyup="coincidencia_guia(this.value,1)"/>
              <span id="txtguia"></span></td>
          </tr>
          <tr>
            <td class="celda_tabla_principal"><div class="letreros_tabla">Embarcador</div></td>
            <td class="celda_tabla_principal celda_boton" width="60%"><div id="dv_embarcador"> <font color="#FF0000"><strong>(*)</strong></font>
              ...
              <button type="button" name="btn_embarcador" id="btn_embarcador" onclick="openPopup('embarcador_nuevo_popup.php','new','750','400','scrollbars=1',true)"> <img src="<?=base_Father?>imagenes/agregar-act.png" alt="" title="Agregar" align="absmiddle"/> </button>
            </div></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="celda_tabla_principal celda_boton"><font color="#FF0000"><strong>(*)</strong></font>
              <input name="piezas" id="digitado_piezas" type="text" size="5" maxlength="10" tabindex="9" onkeypress="return numeric(event)"/></td>
          </tr>
          <tr>
            <td class="celda_tabla_principal"><div class="letreros_tabla">Peso</div></td>
            <td class="celda_tabla_principal celda_boton"><font color="#FF0000"><strong>(*)</strong></font>
              <input name="peso" type="text" size="5" maxlength="10" tabindex="10" onKeyup="numeric2(this)" onblur="numeric2(this)"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="celda_tabla_principal celda_boton"><font color="#FF0000"><strong>(*)</strong></font>
              <input name="descripcion" type="text" id="descripcion" tabindex="12" size="50" onKeyUp="acentos(this.value,this.id)"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="celda_tabla_principal celda_boton"> NO
              <input type="radio" name="precursor" value="N" checked="checked" tabindex="15" />
              SI
              <input type="radio" name="precursor" value="S" tabindex="16"/></td>
          </tr>
          <tr>
            ...
            <td class="celda_tabla_principal celda_boton">
                <div id="dv_agente">
                  <p>
                    ...
                    <button type="button" name="btn__reload_acarga" id="btn__reload_acarga" onclick="llamadasin('ajax_agente_carga.php', 'dv_agente', 'agente')"> <img src="imagenes/recargar-act.png" alt="" title="Recargar" align="absmiddle"/></button>
                    <button type="button" name="btn_acarga" id="btn_acarga" onclick="openPopup('agente_carga_popup.php','new','750','400','scrollbars=1',true)"> <img src="imagenes/agregar-act.png" alt="" title="Agregar" align="absmiddle"/> </button>
                  </p>
                </div>
            </td>
          </tr>
...
<table width="450" align="center">
    ...
    <tr>
      <td align="center" valign="middle" class="celda_tabla_principal celda_boton">
      	<button type="reset" name="reset" id="reset" tabindex="21"> <img src="imagenes/descargar-act.png" alt="" title="Limpiar" /></button>
        <button type="submit" name="guardar" id="guardar" tabindex="20"> <img src="imagenes/guardar-act.png" alt="" title="Guardar" /> </button>
      </td>
    </tr>
</table>
</form>
