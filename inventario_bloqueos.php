...
<p class="asterisco" align="center">BLOQUEADAS</p>
<table width="2550">
  <tr>
    ...
    <td width="180" align="center" class="celda_tabla_principal" style="background-color:<?php echo $colorv ?>" >Vuelo <a href="inventario_general.php?order=v"><img src="imagenes/abajo-act.png" title="Ordenar" border="0" align="absmiddle" /></a></td>
...
$sql="SELECT v.id_aerolinea,v.nvuelo,v.hora_finalizado,v.nmanifiesto,v.id AS 'id_vuelo',g.* FROM vuelo v LEFT JOIN guia g ON v.id = g.id_vuelo WHERE  g.id_tipo_guia !='2' AND (id_tipo_bloqueo = '5' OR id_tipo_bloqueo = '10') AND (g.faltante_total='N') $sql_aerolinea ORDER BY $parametro ASC";
...
{	
	...
	while($fila_posicion=mysql_fetch_array($consulta_posicion))
	{
		...
		$posicion=$posicion." - <a href=\"ubicacion_mapa.php?id_guia=$id_guia\"><font color=\"blue\">$plaqueta</font></a>";
	}
