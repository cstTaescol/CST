...
{
	$guia=$_POST["guia"];
	$sql="SELECT * FROM guia WHERE hija LIKE '%$guia%' AND (id_tipo_bloqueo='3' OR id_tipo_bloqueo='6' OR id_tipo_bloqueo='10') AND (id_disposicion='17' OR id_disposicion='24' OR id_disposicion='16' OR id_disposicion='12') AND faltante_total != 'S' $sql_aerolinea ORDER BY id_consignatario ASC";
}
else
{
	$sql="SELECT * FROM guia WHERE (id_tipo_bloqueo='3' OR id_tipo_bloqueo='6' OR id_tipo_bloqueo='10') AND (id_disposicion='17' OR id_disposicion='24' OR id_disposicion='16' OR id_disposicion='12') AND faltante_total != 'S' $sql_aerolinea ORDER BY id_consignatario ASC";
}
...
while($fila=mysql_fetch_array($consulta))
{
	...
	$tablas=$tablas.'
	<form method="post" action="despacho_cabotaje2.php">
	<tr>
