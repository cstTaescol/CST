...
//*****************
$sql="SELECT * FROM courier_funcionario WHERE estado='$estado_tabla' AND id_entidad='7' ORDER BY nombre ASC LIMIT $pagina , 100";
...
while($fila=mysql_fetch_array($consulta))
	{
		...
		<tr>
		  ...
		  <td class=\"celda_tabla_principal celda_boton\" align=\"center\">
		  	<button type=\"button\" onclick=\"document.location='cambiar_estado_parametricas.php?tabla=courier_funcionario&id_registro=".$fila['id']."&estado_actual=".$fila['estado']."'\">X
			</button>	
		  </td>
		  <td bgcolor=\"#FFFFFF\" align=\"center\">
		  	<button type=\"button\" onclick=\"document.location='modificar_parametrica.php?tabla=courier_funcionario&id_registro=".$fila['id']."'\">Modificar</button>	
		  </td>			  
		</tr>";
	}
