...
{
	$id_cabotaje=$_REQUEST["id"];
	$sql="SELECT observaciones, destinatario FROM cabotaje WHERE id=$id_cabotaje";
...
require("menu.php");
?>
<p class="titulo_tab_principal">Modificar Cabotaje</p>
<p class="asterisco" align="center">Despacho N&uacute;mero: <font size="+2" color="006600"><?php echo $id_cabotaje; ?></font></p>
<form name="complementarios" method="post" action="modificar_cabotaje2.php" onsubmit="return validar();">
  <table align="center">
  <tr>
    ...
    <td class="celda_tabla_principal celda_boton">
        ...
        <input name="id" type="hidden" value="<?php echo $id_cabotaje ?>" />
