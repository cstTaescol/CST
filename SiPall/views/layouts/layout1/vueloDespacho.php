<p class="titulo_tab_principal">Despacho de Vuelo</p>
<p class="asterisco" align="center">Despachar</p>
...
<form name="formulario_guardar" id="formulario_guardar" method="POST" action="<?=base_url?>controllers/AsynController.php" class="was-validated">
  <input type="hidden" name="action" id="action" value="vueloDespachar">
  <table align="center">
      <!-- Aerolinea -->
      <tr>
  ...
  <div id="contenidoPallets" align="center">
    <div class="container">
      <h2>Pallets</h2>
      <p>Seleccione los Pallets que desea despachar <img src="<?=base_Father?>imagenes/avion1.png" width="21" height="22" border="0" align="absmiddle" /></p>            
                  ...
                  <tr>
                    ...
                    <td class="celda_tabla_principal celda_boton">
                      <div id="numero_conectores" class="form-group" style="display: none;">   
                        ...
                        <input id="conectores_bueno" name="conectores_bueno" type="number" class="form-control" min="0" maxlength="11" value="0" required="true" onkeypress="return numeric(event)">
                        <label for="conectores_malo">Mal Estado</label>
                        <input id="conectores_malo" name="conectores_malo" type="number" class="form-control" min="0" maxlength="11" value="0" required="true" onkeypress="return numeric(event)">           
                      </div>                                          
                    </td>   
                  </tr>
