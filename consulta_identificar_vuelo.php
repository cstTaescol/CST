...
<table align="center">
  ...
  <tr>
    <td class="celda_tabla_principal"><div class="letreros_tabla">Guias Registradas</div></td>
    <td colspan="3" class="celda_tabla_principal celda_boton">
    	<p><input type="radio" name="tipodeguia" value="Todas" checked> Todas</p>
      	<p><input type="radio" name="tipodeguia" value="Manifestadas" > Manifestadas</p>
      	<p><input type="radio" name="tipodeguia" value="Finalizadas por Inconsistencias" > Finalizadas por Inconsistencias</p>
    </td>
    </tr>
</table>
				...
				while($fila=mysql_fetch_array($consulta))
					{
						...
						echo '<tr>
								...
								<td align="center"  class="celda_tabla_principal celda_boton" onClick="document.location=\'consulta_vuelo.php?id_vuelo='.$id_vuelo.'&tipo_guias='.$tipodeguia.'\';" > 
									<button type="button">
