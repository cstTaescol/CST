...
if(isset($_GET["id_ddirecto"]))
{
	$id_ddirecto=$_GET["id_ddirecto"];
	//1.
	$sql2="SELECT id,id_guia,peso,piezas,volumen FROM descargue_directo WHERE id = '$id_ddirecto'";
	...
	while($fila2=mysql_fetch_array($consulta2))
	{
		...
		//2.
		$sql_despacho="DELETE FROM descargue_directo WHERE id='$id_registro'";
		...
		$sql_trak="INSERT INTO tracking (id_guia,
										 ...
										 id_usuario) value 
												('$id_guia',
												 ...
												 POR QUE ELIMINAN EL DESPACHO No.$id_ddirecto',
												 '1',
												 '$id_usuario')";
	...
	echo "
			<script language=\"javascript\">
				alert(\"DESCARGUE DIRECTO Eliminado Satisfactoriamente, Las GUIAS asociadas a este DESPACHO, han vuelto a estar disponibles en el INVENTARIO.\");
