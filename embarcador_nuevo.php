...
<table align="center">
  ...
  <tr>
    ...
    <td class="celda_tabla_principal celda_boton"><input name="telefono" id="telefono" type="text" size="30" maxlength="10" onkeypress="return numeric(event)" /></td>
  </tr>
  <tr>
    <td class="celda_tabla_principal"><div class="letreros_tabla">Direccion</div></td>
    <td class="celda_tabla_principal celda_boton"><input name="direccion" id="direccion" type="text" size="30" maxlength="200" /></td>
  </tr>
</table>
    <table width="450" align="center">
        ...
        <tr>
          <td align="center" valign="middle" class="celda_tabla_principal celda_boton">
            <button type="button" name="cancelar" id="cancelar" onClick="document.location='consulta_identificar_parametricas.php?tabla=embarcador'">
