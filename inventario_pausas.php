...
$sql="SELECT * FROM guia WHERE id_tipo_bloqueo = '11' $sql_aerolinea";
...
while($fila=mysql_fetch_array($consulta))
{
	...
	$volumentotal=$volumentotal+$fila["volumen"];
	$cantidadguias++;
...
?>
<p class="titulo_tab_principal">Inventario de Pausadas</p>
<table align="center">
  <tr>
