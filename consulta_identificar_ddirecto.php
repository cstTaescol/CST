...
{
var respuesta=confirm('ATENCION: Confirma que Desea Eliminar el Descargue Directo?,  Las GUIAS despachadas seran Retornadas al INVENTARIO');
if (respuesta)
	{
		window.location="eliminar_ddirecto1.php?id_ddirecto="+url;
	}
}
</script>
</head>
...
require("menu.php");
?>
<p class="titulo_tab_principal">Buscador de D. Directos</p>
...
if (isset($_POST["coincidencia"]) or isset($_POST["rango"]))
	{
		...
		if	($condicion != "Error")
			{
				$sql="SELECT * FROM descargue_directo WHERE $condicion AND estado ='A'";
				...
				<tr>
					...
					<td class=\"celda_tabla_principal\"><div class=\"letreros_tabla\">Levante</div></td>
						...
						if ($guia != "")
						{
							echo "<tr>
									<td align=\"center\" class=\"celda_tabla_principal celda_boton\">
										<button type=\"button\" onClick=\"abrir('pdf_descargue_directo.php?id_ddirecto=$id_ddirecto')\">
											<img src=\"imagenes/imprimir-act.png\" title=\"Impresion\" />
										</button>
									</td>
									<td align=\"center\" class=\"celda_tabla_principal celda_boton\">
										<button type=\"button\" onClick=\"document.location='modificar_ddirecto1.php?id_ddirecto=$id_ddirecto'\" $activacion1>
											<img src=\"imagenes/settings-act.png\" title=\"Modificar\" />
										</button>
									</td>
									<td align=\"center\" class=\"celda_tabla_principal celda_boton\">
										<button type=\"button\" onClick=\"conf_eliminar($id_ddirecto);\" $activacion2>
											<img src=\"imagenes/eliminar-act.png\" title=\"Eliminar\" />
										</button> 
									</td>								
									<td class=\"celda_tabla_principal celda_boton\"> $id_ddirecto </td>
									<td class=\"celda_tabla_principal celda_boton\"> $guia </td>
									<td class=\"celda_tabla_principal celda_boton\"> $levante </td>
