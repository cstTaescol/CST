...
//Contador de paginas
$sql="SELECT id FROM movilizacion WHERE estado='$estado_tabla'";
...
//*****************
$sql="SELECT * FROM movilizacion WHERE estado='$estado_tabla' ORDER BY nombre ASC LIMIT $pagina , 100";
...
while($fila=mysql_fetch_array($consulta))
	{
		...
		<tr>
		  ...
		  <td class=\"celda_tabla_principal celda_boton\">".$fila['tipo']."</td>			  
		  <td class=\"celda_tabla_principal celda_boton\">".$fila['estado']."</td>
		  <td bgcolor=\"#FFFFFF\" align=\"center\">
			<button type=\"button\" onclick=\"document.location='cambiar_estado_parametricas.php?tabla=movilizacion&id_registro=".$fila['id']."&estado_actual=".$fila['estado']."'\">X
			</button>	
		  </td>
		</tr>";
	}
...
require("menu.php");
?>
<p class="titulo_tab_principal">Lista de In/Movilizaciones</p>
