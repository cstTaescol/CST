...
<table align="center">
  <tr>
    ...
    <td class="celda_tabla_principal"><div class="letreros_tabla">Hija <input type="radio" name="tipo_guia" value="h"></div></td>
...
if (isset($_POST["coincidencia"]) or isset($_POST["rango"]))
	{
		...
		if ($tguia=="m")
		{
			...
			$subtipo="master";			
			$url2="consulta_guia_courier.php";
		}
		else
			{
				$tipo_guia="id_tipo_guia='6'";
				$subtipo="hija";				
				$url2="consulta_guia_courier_hija.php";
			}
