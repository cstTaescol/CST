...
require("menu.php");
?>
<p class="titulo_tab_principal">Reporte de Trasbordo</p>
<p class="asterisco" align="center">Despacho identificado con exito... N&uacute;mero: <font size="+2" color="006600"><?php echo $id_trasbordo; ?></font></p>
...
<table width="450" align="center">
    ...
    <tr>
      <td align="center" valign="middle" class="celda_tabla_principal celda_boton">
            ...
            <button name="modificar" type="button" onClick="document.location='modificar_trasbordo1.php?id=<?php echo $id_trasbordo ?>'">
                <img src="imagenes/settings-act.png" title="Modificar" /><br />
              <strong>Modificar</strong>
            </button>
            
            <button name="eliminar" type="button" onClick="conf_eliminar(<?php echo $id_trasbordo ?>);">
                <img src="imagenes/eliminar-act.png" title="Eliminar" /><br />
              <strong>Eliminar</strong>
            </button>
            
            <button name="imprimir" type="button" onClick="abrir('pdf_trasbordo.php?id_trasbordo=<?php echo $id_trasbordo ?>')">
