...
if(isset($_REQUEST["id_funcionario"]))$id_funcionario=$_REQUEST["id_funcionario"];
...
$sql="INSERT INTO courier_funcionarios_guia (
											id_guia,
											id_funcionario
											) 
											VALUE (
...
$registro_novedad ="Funcionario de $nombre_entidad Adicionado: ".
          "<br>".
