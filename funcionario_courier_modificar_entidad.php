...
?>
<p class="titulo_tab_principal">Funcionarios</p>
...
function guardar_form()
{
	...
	{
		url: 'funcionario_courier_modificar_entidad_salvar.php',
		method: 'post',
		onRequest: function()
		{
		...
		onSuccess: function(responseText)
		{
			...
			switch (respuesta)
			{
				...
				case 1:
					...
					document.location='listar_courier_funcionario_entidad.php';
				break;
			}
