<?php
	$sql="SELECT * FROM agente_carga WHERE id='$id_registro'";
	...
	$emails=$fila['emails'];	
?>
<p class="titulo_tab_principal">Agente de Carga</p>
...
<form method="post" name="frm_guardar" id="frm_guardar">
	<table align="center">
	    <tr>
	      ...
	      <td class="celda_tabla_principal celda_boton"><input type="hidden" name="id" id="id" value="<?php echo $id; ?>" /><?php echo $nombre; ?></tr>
	    <tr>
	      <td class="celda_tabla_principal"><div class="letreros_tabla">Telefono</div></td>
	      <td class="celda_tabla_principal celda_boton"><input name="telefono" id="telefono" type="text" tabindex="2" size="30" maxlength="10" value="<?php echo $telefono; ?>"></td>
	    </tr>
	    <tr>
	      <td class="celda_tabla_principal"><div class="letreros_tabla">Direccion</div></td>
	      <td class="celda_tabla_principal celda_boton"><input name="direccion" id="direccion" type="text" tabindex="3" size="30" maxlength="200" value="<?php echo $direccion; ?>"></tr>
	    <tr>
	    <tr>
	      <td class="celda_tabla_principal"><div class="letreros_tabla">E-mail</div></td>
	      <td class="celda_tabla_principal celda_boton"><input name="emails" id="emails" type="text" tabindex="4" size="30" value="<?php echo $emails; ?>"></td>
	    </tr>
    ...
    <table width="450" align="center">
        ...
        <tr>
          <td align="center" valign="middle" class="celda_tabla_principal celda_boton">
            <button type="button" name="cancelar" id="cancelar" onclick="document.location='listar_agente_carga.php'">
...
function guardar_form()
{
	...
	{
		url: 'agente_carga_modificar_salvar.php',
		method: 'post',
		onRequest: function()
		{
		...
		onSuccess: function(responseText)
		{
			...
			switch (respuesta)
			{
				...
				case 1:
					...
					document.location='listar_agente_carga.php';
				break;
			}
