...
<style>
	input{width:40px; height:40px; text-align:center; font-size:30px;}
	.estilotextobuscador{font-size:18pt;font-weight:bold;letter-spacing:5px;font-family: Garamond,verdana;width:650;}
</style>
</head>
<body onLoad="teclado();">
<?php
...
//---------------------------
?>
<p class="titulo_tab_principal">Tracking de Guia</p>
<form name="tracking" action="consulta_tracking2.php" method="post" onsubmit="return validar();">
...
function validar()
{	
	if (document.forms[0].ta.value=="")
	{
		alert("Atencion: Digite el numero de GUIA");
		document.forms[0].ta.focus();
		return(false);
	}
}
</script>  
