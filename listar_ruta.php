...
//Contador de paginas
$sql="SELECT id FROM ruta WHERE estado='$estado_tabla'";
...
//*****************
$sql="SELECT * FROM ruta WHERE estado='$estado_tabla' ORDER BY descripcion ASC LIMIT $pagina , 100";
$consulta=mysql_query ($sql,$conexion) or die ("ERROR: ". mysql_error(). " INFORME AL SOPORTE TECNICO");
while($fila=mysql_fetch_array($consulta))
	{
		$impresion=$impresion."
		<tr>
		  <td class=\"celda_tabla_principal celda_boton\">".$fila['descripcion']."</td>
		  <td class=\"celda_tabla_principal celda_boton\">".$fila['estado']."</td>
		  <td class=\"celda_tabla_principal celda_boton\" align=\"center\">
			<button type=\"button\" onclick=\"document.location='cambiar_estado_parametricas.php?tabla=ruta&id_registro=".$fila['id']."&estado_actual=".$fila['estado']."'\">X
			</button>	
		  </td>
		</tr>";
	}
...
require("menu.php");
?>
<p class="titulo_tab_principal">Lista de Rutas</p>
